...
public class ChatClient  extends UnicastRemoteObject implements _ChatClient {

	private static final long serialVersionUID = 7468891722773409712L;
	ClientRMIGUI chatGUI;
	private String hostName = "147.171.175.111:"+Constant.portNumber;
	private String serviceName = Constant.RMIName;//"GroupChatService";
	private String clientServiceName;
	private String name;
	//protected _ChatServerInterface serverIF;
	protected _ChatServer serverIF;
	...
	public void startClient() throws RemoteException {		
		...
		try {
			...
			//serverIF = ( _ChatServerInterface )Naming.lookup("rmi://" + hostName + "/" + serviceName);	

			serverIF = ( _ChatServer )Naming.lookup("rmi://" + hostName + "/" + serviceName);	
		} 
